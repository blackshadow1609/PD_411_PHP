<form class="login-card" action="inc/quitz.php" method="post">
    ...
    <div class="login-item"><label for="email">        E-mail:     </label><input type="text" name="email"          id="email"          placeholder="E-mail"/></div>
    
    <div class="login-item"><label style="width:53.7%;"></label><button type="submit">Start</button></div>
</form>